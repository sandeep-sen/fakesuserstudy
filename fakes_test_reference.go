...
func Test_VirtualMachinesClient_Get_Ref(t *testing.T) {
...
func Test_VirtualMachinesClient_Get_error_Ref(t *testing.T) {
	// write a fake for VirtualMachinesClient.Get that includes the following data
...
func Test_VirtualMachinesClient_BeginCreateOrUpdate_Ref(t *testing.T) {
...
func Test_VirtualMachinesClient_NewListPager_Ref(t *testing.T) {
